...
The p-value for the fisher exact test (white&black) is 0.00001183. The p-value for (white&other) is .00721. Thus, there is clear evidence so we can reject the null hypothesis. White people are double as likely to eat out compared to black people. 

# Discussion and Conclusion

The original question was if race and the amount of times each went out to dine mattered. If whether these two categorical values were dependent or independent from one another. We cam conclude that the race and how often they dined out were different from one another. They are dependent. We reject the null hypotheses because all p-values we adressed were lower than .05. 
